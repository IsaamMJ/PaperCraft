...
class StudentRepositoryImpl implements StudentRepository {
  ...
  Future<Either<Failure, StudentEntity>> addStudent({
    ...
    try {
      ...
      logger.info('Student added: $rollNumber - $fullName', category: 'StudentRepository');
      return Right(result);
      ...
      logger.error('Postgres error adding student: ${e.message}', category: 'StudentRepository');
      return Left(ServerFailure(e.message, code: e.code));
    } on SocketException catch (e) {
      logger.error('Network error adding student: ${e.message}', category: 'StudentRepository');
      return Left(NetworkFailure('Network error: ${e.message}'));
    } catch (e) {
      logger.error('Error adding student: ${e.toString()}', category: 'StudentRepository');
  ...
  Future<Either<Failure, List<StudentEntity>>> getStudentsByGradeSection(
    ...
    try {
      ...
      logger.info('Fetched ${students.length} students for grade section', category: 'StudentRepository');
      return Right(students.cast<StudentEntity>());
    } on SocketException catch (e) {
      logger.error('Network error fetching students: ${e.message}', category: 'StudentRepository');
      return Left(NetworkFailure('Network error: ${e.message}'));
    } catch (e) {
      logger.error('Error fetching students: ${e.toString()}', category: 'StudentRepository');
  ...
  Future<Either<Failure, StudentEntity>> getStudentById(String studentId) async {
    try {
      ...
      logger.error('Error fetching student: ${e.toString()}', category: 'StudentRepository');
  ...
  Future<Either<Failure, List<StudentEntity>>> getActiveStudents() async {
    try {
      ...
      logger.error('Error fetching active students: ${e.toString()}', category: 'StudentRepository');
      return Left(ServerFailure('Failed to fetch students: ${e.toString()}'));
    }
  }
  ...
  Future<Either<Failure, StudentEntity>> updateStudent(StudentEntity student) async {
    try {
      ...
      logger.info('Student updated: ${student.rollNumber}', category: 'StudentRepository');
      return Right(result);
    } on PostgrestException catch (e) {
      logger.error('Postgres error updating student: ${e.message}', category: 'StudentRepository');
      return Left(ServerFailure(e.message, code: e.code));
    } catch (e) {
      logger.error('Error updating student: ${e.toString()}', category: 'StudentRepository');
  ...
  Future<Either<Failure, void>> deleteStudent(String studentId) async {
    try {
      ...
      logger.info('Student deleted: $studentId', category: 'StudentRepository');
      return const Right(null);
    } catch (e) {
      logger.error('Error deleting student: ${e.toString()}', category: 'StudentRepository');
  ...
  Future<Either<Failure, List<StudentEntity>>> bulkUploadStudents({
    ...
    try {
      ...
      logger.info('Bulk uploaded ${result.length} students, ${duplicates.length} duplicates skipped',
          category: 'StudentRepository');

      return Right(result.cast<StudentEntity>());
    } on PostgrestException catch (e) {
      logger.error('Postgres error bulk uploading students: ${e.message}', category: 'StudentRepository');
      return Left(ServerFailure(e.message, code: e.code));
    } catch (e) {
      logger.error('Error bulk uploading students: ${e.toString()}', category: 'StudentRepository');
  ...
  Future<Either<Failure, bool>> studentExists({
    ...
    try {
      ...
      logger.error('Error checking student existence: ${e.toString()}', category: 'StudentRepository');
  ...
  Future<Either<Failure, int>> getStudentsCountByGradeSection(String gradeSectionId) async {
    try {
      ...
      logger.error('Error getting student count: ${e.toString()}', category: 'StudentRepository');
  ...
  Future<Either<Failure, List<StudentEntity>>> getStudentsWithPagination({
    ...
    try {
      ...
      logger.error('Error fetching paginated students: ${e.toString()}', category: 'StudentRepository');
      return Left(ServerFailure('Failed to fetch students: ${e.toString()}'));
    }
  }
}
