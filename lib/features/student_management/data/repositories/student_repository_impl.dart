...
class StudentRepositoryImpl implements StudentRepository {
  ...
  Future<Either<Failure, StudentEntity>> addStudent({
    ...
    try {
      ...
      // Note: gradeNumber and sectionName are display fields fetched via relations
    ...
    try {
      ...
      for (final data in studentData) {
        ...
        if (exists) {
          ...
          DateTime? dateOfBirth;
          final dobString = data['date_of_birth'];
          if (dobString != null && dobString.isNotEmpty) {
            try {
              ...
              try {
                ...
                print('[DEBUG REPO] Failed to parse DOB for student $rollNumber: $e (ISO) and $e2 (DD-MM-YYYY)');
                dateOfBirth = null;
              }
            }
          }
