...
class _SettingsPageState extends State<SettingsPage> {
  ...
  int? _getSubjectCount() => _subjectCount;
  int? _getGradeCount() => _gradeCount;
  int? _getExamTypeCount() => _examTypeCount;
  int? _getUserCount() => _userCount;
